...
def test_generate_question_list():
    ...
    expected_result = [{'question': 'I ate a banana.', 'incorrect_list': ['A color', 'A car', 'A movie'], 'correct': 'A fruit', 'table_name': 'QUESTION_DEFINITION', 'word': 'banana'}, {'question': 'I ate an apple.', 'incorrect_list': ['A color', 'A car', 'A movie'], 'correct': 'A fruit', 'table_name': 'QUESTION_DEFINITION', 'word': 'apple'}]
